...
cron.schedule('* * * * *', async (req,res) => {
  ...
  let allData =  await Promise.all( response.map( async (item)=>{
      ...
      console.log("cronjob api calling get_card_008==" );
 return true
...
// match_card -21 calling conjon
 ...
 let allData =  await Promise.all( response.map( async (item)=>{
     ...
     console.log("cronjob api calling card -21 ==" );
    return true;

 } catch(error) { console.log( "cronjob api calling card-21 server error  == ", error);
                 return false ; 
             }    
...
cron.schedule('* * * * *', async (req,res) => {
   try {
      ...
      //let url = 'http://localhost:3600/open_api/get_card_02';
  ...
  let allData =  await Promise.all( response.map( async (item)=>{
      ...
      console.log("cronjob api calling card -2 ==" );
     return true;
...
cron.schedule('* * * * *', async (req,res) => {
      ...
      if(response.length>0){  
          ...
          let allData =  await Promise.all( response.map( async (item)=>{
              ...
              console.log("cronjob api calling card -3 ==" );
             return true;
          } catch(error) { console.log( "cronjob api calling card-3 server error  == ", error);
                          return false ; 
                      }    
...
cron.schedule('* * * * *', async (req,res) => {
  ...
  let allData =  await Promise.all( response.map( async (item)=>{
      ...
      console.log("cronjob api calling card -6 ==" );
  return true; 
...
cron.schedule('* * * * *', async (req,res) => {
  ...
  let allData =  await Promise.all( response.map( async (item)=>{
      ...
      console.log("cronjob api calling card -9 ==" );
      return true;
...
cron.schedule('* * * * *', async (req,res) => {
  ...
  let allData =  await Promise.all( response.map( async (item)=>{
      ...
      console.log("cronjob api calling card -16 ==" );
      return true;
...
cron.schedule('* * * * *', async (req,res) => {
  ...
  let allData =  await Promise.all( response.map( async (item)=>{
      ...
      console.log("cronjob api calling card -18 ==" );
      return true;
  } catch(error) { console.log( "cronjob api calling card-18 server error  == ", error);
                  return false ; 
              }    
...
cron.schedule('* * * * *', async (req,res) => {
  ...
  let allData =  await Promise.all( response.map( async (item)=>{
      ...
      console.log("cronjob api calling card -19 ==" );
    return true;
...
cron.schedule('* * * * *', async (req,res) => {
  ...
  let allData =  await Promise.all( response.map( async (item)=>{
      ...
      console.log("cronjob api calling card -22 ==" );
      return true;
...
cron.schedule('* * * * *', async (req,res) => {
  ...
  let allData =  await Promise.all( response.map( async (item)=>{
      ...
      //console.log("cronjob api calling update_live_match_data_by_match_id ==", sumArr );
      return true;
  } catch(error) { console.log( "cronjob api calling update_live_match_data_by_match_id server error  == ", error);
                  return false ; 
              }    
