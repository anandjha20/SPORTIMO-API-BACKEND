...
export default function TeamsPreference() {
    ...
    const saveFormData = async (e) => {
        ...
        try {
            ...
            axios.put(`/web_api/teams/${_id}`, dataToSend2, options1)
                .then(res => {
                    if (res.status) {
                                            ...
                                            <div className="col-lg-5">
                                                ...
                                                <form className="mt-3" onSubmit={(e) => AddFormData(e)}>
                                                    ...
                                                    <TextField id="categor" className="filter-input" name="name" autoComplete="off"
                                                        onChange={handleOnChange} label="Team Preference" fullWidth type="text"
                                                        InputLabelProps={{
                                                            shrink: true,
                                                        }}
                                                    />
                                                    ...
                                                    <div className="col-lg-12">
                                                        ...
                                                        <div className="table-card MuiPaper-root MuiPaper-elevation2 MuiPaper-rounded">
                                                            ...
                                                            <table className="table ">
                                                                <thead>
                                                                    <tr>
                                                                        <th scope="col">Teams Preference</th>
