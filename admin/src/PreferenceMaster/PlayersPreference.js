...
export default function TeamsPreference() {
    ...
    const onOpenModal = (_id) => {
        axios.post(`/web_api/players_get/${_id}`)
            .then(res => {
    ...
    const deleteCategory = (_id) => {
        ...
        axios.delete(`/web_api/players/${_id}`)
            .then(res => {
                if (res.status) {
                    let data = res.data;
    ...
    const SportPreferenceList = async (page) => {
        ...
        await axios.post(`/web_api/players_get`,)
            .then(res => {
    ...
    const saveFormData = async (e) => {
        ...
        try {
            ...
            axios.put(`/web_api/players/${_id}`, dataToSend2, options1)
                .then(res => {
                    if (res.status) {
    ...
    /////////////////// Add  Players Preference API call ///////////////////////////////////////////////// 
                                            ...
                                            <div className="col-lg-5">
                                                ...
                                                <form className="mt-3" onSubmit={(e) => AddFormData(e)}>
                                                    ...
                                                    <TextField id="categor" className="filter-input" name="name" autoComplete="off"
                                                        onChange={handleOnChange} label="Players Preference" fullWidth type="text"
                                                        InputLabelProps={{
                                                            shrink: true,
                                                        }}
                                                    />
                                                    ...
                                                    <div className="col-lg-12">
                                                        ...
                                                        <div className="table-card MuiPaper-root MuiPaper-elevation2 MuiPaper-rounded">
                                                            ...
                                                            <table className="table ">
                                                                <thead>
                                                                    <tr>
                                                                        <th scope="col">Players Preference</th>
