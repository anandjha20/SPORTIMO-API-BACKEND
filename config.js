...
const local_default = require('./local_default.json');
  ...
  mongoose.connect('mongodb://admin:root@10.8.0.106:3000/sportimo?authSource=admin&retryWrites=true&w=majority');
  //mongoose.connect('mongodb://admin:root@3.236.132.255:3000/sportimo?authSource=admin&retryWrites=true&w=majority');
