...
router.post('/live_upcoming_match_all_data', MasterController.live_upcoming_match_all_data);
router.put('/match_chat_time_update/:id?', MasterController.match_chat_time_update);
