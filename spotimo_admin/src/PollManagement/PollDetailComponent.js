...
const get_data = async(id)=>{
  ...
  {  try{ 
      let formData = {};    let options1 = { headers:{"Content-type": "application/json" }};
      let response = await axios.get('/poll_list/'+id ,formData,options1);
                    ...
                    <form>
                      <div className="row">
                        ...
                        <div className="col-lg-6 mb-4">
                          ...
                          defaultValue= {pollData.ops_1}  variant="filled" InputProps={{readOnly: true, }} 
                         />
                        </div>
